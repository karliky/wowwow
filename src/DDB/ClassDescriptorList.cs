...
namespace DDB
{
	public class ClassDescriptorList : IDictionary, ICollection, IEnumerable, ICloneable
	{
        ...
        public ClassDescriptorList(IEqualityComparer codeProvider)
		{
			innerHash = new Hashtable(codeProvider);
		}
        ...
        public ClassDescriptorList(IDictionary dictionary, IEqualityComparer codeProvider)
		{
			innerHash = new Hashtable(dictionary, codeProvider);
		}

        public ClassDescriptorList(int capacity, IEqualityComparer codeProvider)
		{
			innerHash = new Hashtable(capacity, codeProvider);
		}

        public ClassDescriptorList(IDictionary dictionary, float loadFactor, IEqualityComparer codeProvider)
		{
			innerHash = new Hashtable(dictionary, loadFactor, codeProvider);
		}

        public ClassDescriptorList(int capacity, float loadFactor, IEqualityComparer codeProvider)
		{
