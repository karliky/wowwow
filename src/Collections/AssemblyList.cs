...
namespace HelperTools
{
	public class AssemblyList : IDictionary, ICollection, IEnumerable, ICloneable
	{
        ...
        public AssemblyList(IEqualityComparer codeProvider)
		{
		...
		public AssemblyList(IDictionary dictionary, IEqualityComparer codeProvider)
		{
			innerHash = new Hashtable(dictionary, codeProvider);
		}

        public AssemblyList(int capacity, IEqualityComparer codeProvider)
		{
			innerHash = new Hashtable(capacity, codeProvider);
		}

        public AssemblyList(IDictionary dictionary, float loadFactor, IEqualityComparer codeProvider)
		{
			innerHash = new Hashtable(dictionary, loadFactor, codeProvider);
		}

        public AssemblyList(int capacity, float loadFactor, IEqualityComparer codeProvider)
		{
