...
namespace Server
{
	public enum SpellFailedReason 
	{
		Success = -1,
		NotInCombat    =0x0,
		AlreadyAtFullHealth  =0x1,
		AlreadyAtFullRage =0x2,
		AlreadyBeenTamed        =0x3,
		AlreadyControlACreature        =0x4,
		AlreadyControlASummonedCreature =0x5,
		AlreadyOpen         =0x6,
		AMorePowerfulSpellAlreadyActive     =0x7,
		Failed        =0x8,// no longer work 1.6.x
		DontHaveATarget    =0x9,
		InvalidTarget         =0xA,
		CanontBeCharmed         =0xB,
		ItemCanotBeDesenchanted       =0xC,
		TargetIsTapped =0xD,
		YouCantStartADuelWhileInvisible               =0xE,
		YouCantStartADuelWhileStealth              =0xF,
		TooClosedTooEnemies     =0x10,
		YouCantDoThatYet         =0x11,
		YouAreDead  =0x12,
		ThisIsAlreadyBeeingUsed= 0x13,
		CantDoThatWhileConfused      = 20,
		Unknown      =21,
		MustHaveAProperItemEquiped   =22,
		MustHaveANewItemEquipedInMainHand       =23,
		MustHaveANewItemEquiped       =24,
		InternalError            =25,
		Fizzled       =26,
		CantDoThatWhileFleeing              =27,
		ThatsFoodLevelIsNotEnoughForYouPet           =28,
		TargetIsTooHighLevel     =29,
		YooAreTooFullToEat    =30,
		Immune              =31,
		Interrupted         =32,
		Interrupted2          =33,
		ItemIsAlreadyEnchanted  =34,
		ItemIsGone            =35,
		TriedToEnchantAnItemThatDoesntExist           =36,
		ItemIsNotReadyYet         = 37,
		YouAreNotEnoughLevel           = 38,
		TargetNotLineOfSight      = 39,
		TargetIsTooLowLevel         = 40,
		SkillNotHighEnough             = 41,
		YourWeaponHandIsEmpty   = 42,
		CantDoWhileMoving        = 43,
		AmnoNeeded              = 44,
		Required            = 45,//%s
		RequiredExoticAmno     = 46,//%s
		NoPathAvailable        = 47,
		YouMustBeBehindYourTarget        = 48,
		YourCastDidtFallInWater        = 49,
		SpellCantCastHere      = 50,
		YouMustBeInFrontOfYourTarget       = 51,
		YourAreNotInControlOfYourActions     = 52 ,
		SpellNotLearned      = 53,
		CannotUsedWhileMounted     = 54,
		YourAreInFligth        = 55,
		YourAreOnTransport		= 56,

		AbilityIsntReadyYet            = 57,
		CanotUseShapeshiftForm            =58,
		YouHaveToStandingToDoThat = 59,
		YouCanOnlyUseThisOnAObjectYouOwned            = 60,
		TryToEnchantAtradeItemButNotTrading   = 61,
		YouHaveToBeUnshealthToDoThat       = 62,
		CantCastAsGhost   = 63,
		OutOfAmno             = 64,
		NoChargeRemains        = 65,
		ThisAbilityRequireComboPoint= 66,
		DuelingIsntAllowHere    = 67,
		NotEnoughEndurance        = 68,
		TheyArentAnyFishHere      = 69,
		CantUseItemWhileShapeshift     = 70,
		YouCantMountHere    = 71,
		YouDoNotHaveAPet     = 72,
		NotEnoughMana = 73,
		
		
	//	CanOnlyUseIndoor           =0x4A,
		CantUseWhileSwiming   = 74,
		CanOnlyBeUseDuringTheDay = 75,
		CanOnlyBeUseDuringTheNight          =76,		
		CanOnlyUseIndoor           = 76,
		CanOnlyUseMounted              = 77,
	//	CanOnlyBeUseDuringTheDay     = 78,
		CanOnlyUseOutside     =79,
		Unknown2     =0x4E,
		YouMustBeInStealthMode    =81,
		CanOnlyUseWhileSwimming   =82,
		OutOfRange        =83,
		CanUseThisAbilityWhilePacified     =84,
		YouArePossessed   =85,
		Uknown3      =86,
		YouNeedToBeIn       =87,//%s
		Require        =88,//%s
		YouAreUnableToMove = 89,
		CanDoWhileSilenced = 90,
		AnotherActionIsInProgress = 91,
		YouHaveAlreadyLearnedThatSpell = 92,
		TheSpellIsNotAvailableForYou = 93,
		CantDoWhileStuned = 94,
		TheTargetIsDead = 95,
		TargetIsInCombat = 96,
		YouCantDoThatYet2 = 97,
		TargetIsCurentlyDueling = 98,
		TargetIsHostile = 99,
		TargetIsTooEnrageToBeCharmed = 100,
		TargetIsFriendly = 101,
		TheTargetCannotBeInCombat = 102,
		CantTargetPlayer = 103,
		TargetIsAlive = 104,
		TargetIsNotInYourParty = 105,
		CreatureMustBeLootedFirst = 106,
		Unknow4 = 107,
		NoPocketToPick = 108,
		TargetHasNotWeaponEquiped = 109,
		CreatureIsNotSkinable = 110,
		YourFirstIsAlreadyQuenched = 111,
		TargetTooClose = 112,
		YouHaveTooManyOfThatItem = 113,
		UnknowSuccess112 = 114,
		NotEnoughTrainningPoint = 115,
		FailedAttempt = 116,
		TargetNeedToBeBehindYou = 117,
		TargetNeedToBeFrontOfYou = 118,
		YourPetDoesntLikeThatFood = 119,
		CantCastWhileFatigued = 120,
		TargetMustBeInThisInstance = 121,
		CantCastWhileTrading = 122,
		TargetIsNotInYourParty2 = 123,//121
		CannotDisenchantWhileLooting = 124,//122
		TargetIsCurrentlyInFreeForAllPvpCombat = 125,
		ThereAreNoNearbyCorpseToEat = 126,
		CanOnlyUseInBattleground = 127,
		UnknowReason = 128
	};
    ...
    public enum OpCodes
{
    ...
    CMSG_MAKEMONSTERATTACKME_OBSOLETE = 0x0015,
    ...
    CMSG_SET_TARGET_OBSOLETE = 0x013E,
    CMSG_UNUSED = 0x013F,
    CMSG_UNUSED2 = 0x0140,
    ...
    CMSG_PLAYER_MACRO_OBSOLETE = 0x01E3,
    SMSG_PLAYER_MACRO_OBSOLETE = 0x01E4,
    CMSG_GHOST = 0x01E5,
    ...
    MSG_ADD_DYNAMIC_TARGET_OBSOLETE = 0x01F0,
    ...
    SMSG_STANDSTATE_CHANGE_ACK = 0x029D,
    ...
    SMSG_MEETINGSTONE_JOINFAILED = 0x02BB,
    ...
    SMSG_HARDWARE_SURVEY_REQUEST = 0x02E6,
    CMSG_HARDWARE_SURVEY_RESULTS = 0x02E7,
    SMSG_WARDEN_DATA = 0x02E8,
    CMSG_WARDEN_DATA = 0x02E9,
    SMSG_GROUP_JOINED_BATTLEGROUND = 0x02EA,
    MSG_BATTLEGROUND_PLAYER_POSITIONS = 0x02EB,
    CMSG_PET_STOP_ATTACK = 0x02EC,
    SMSG_BINDER_CONFIRM = 0x02ED,
    SMSG_BATTLEGROUND_PLAYER_JOINED = 0x02EE,
    SMSG_BATTLEGROUND_PLAYER_LEFT = 0x02EF,
    CMSG_BATTLEMASTER_JOIN = 0x02F0,
    SMSG_ADDON_INFO = 0x02F1,
    CMSG_PET_UNLEARN = 0x02F2,
    SMSG_PET_UNLEARN_CONFIRM = 0x02F3,
    SMSG_PARTY_MEMBER_STATS_FULL = 0x02F4,
    CMSG_PET_SPELL_AUTOCAST = 0x02F5,
    SMSG_WEATHER = 0x02F6,
    SMSG_PLAY_TIME_WARNING = 0x02F7,
    SMSG_MINIGAME_SETUP = 0x02F8,
    SMSG_MINIGAME_STATE = 0x02F9,
    CMSG_MINIGAME_MOVE = 0x02FA,
    SMSG_MINIGAME_MOVE_FAILED = 0x02FB,
    CMSG_GUILD_CHANGEINFO = 0x02FC
}
...
,SMSG_MEETING_STONE_INFO					=  0x0295
,CMSG_MEETING_STONE_INFO                    =  0x0296
