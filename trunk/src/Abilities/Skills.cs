...
namespace Server
{
	public class Skills : IDictionary, ICollection, IEnumerable, ICloneable
	{
        ...
        public Skills(IEqualityComparer codeProvider)
		{
		...
		public Skills(IDictionary dictionary, IEqualityComparer codeProvider)
		{
			innerHash = new Hashtable(dictionary, codeProvider);
		}

        public Skills(int capacity, IEqualityComparer codeProvider)
		{
			innerHash = new Hashtable(capacity, codeProvider);
		}

        public Skills(IDictionary dictionary, float loadFactor, IEqualityComparer codeProvider)
		{
			innerHash = new Hashtable(dictionary, loadFactor, codeProvider);
		}

        public Skills(int capacity, float loadFactor, IEqualityComparer codeProvider)
		{
