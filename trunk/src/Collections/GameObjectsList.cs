...
namespace Server
{
	public class GameObjectsList : IDictionary, ICollection, IEnumerable, ICloneable
	{
		...
		public GameObjectsList(IEqualityComparer codeProvider)
		{
		...
		public GameObjectsList(IDictionary dictionary, IEqualityComparer codeProvider)
		{
			innerHash = new Hashtable(dictionary, codeProvider);
		}
		
		public GameObjectsList(int capacity, IEqualityComparer codeProvider)
		{
			innerHash = new Hashtable(capacity, codeProvider);
		}
		
		public GameObjectsList(IDictionary dictionary, float loadFactor, IEqualityComparer codeProvider)
		{
			innerHash = new Hashtable(dictionary, loadFactor, codeProvider);
		}

        public GameObjectsList(int capacity, float loadFactor, IEqualityComparer codeProvider)
		{
